<div class="left-side-menu mm-show">
                    ...
                    <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                        <div class="simplebar-content" style="padding: 0px;">
                            ...
                            <ul class="metismenu side-nav mm-show">
                                ...
                                <li class="side-nav-item">
                                    <a href="apps-calendar.html" class="side-nav-link" aria-expanded="false">
                            ...
                            <li class="side-nav-item">
                                ...
                                <ul class="side-nav-second-level mm-collapse" aria-expanded="false">
                                    ...
                                    <li class="side-nav-item">
                                        <a href="apps-social-feed.html" class="side-nav-link" aria-expanded="false">
                                            <i class="uil-rss"></i>
                            ...
                            <li class="side-nav-item">
                                <a href="landing.html" target="_blank" class="side-nav-link" aria-expanded="false">
                                    <i class="uil-globe"></i>
                            ...
                            <li class="side-nav-item">
                                <a href="javascript: void(0);" class="side-nav-link active" aria-expanded="false">
                                ...
                                <li class="mm-active">
                                    <a href="layouts-vertical.html" class="active">Vertical</a>
                                </li>
                                <li>
                        ...
                        <li class="side-nav-item">
                            <a href="widgets.html" class="side-nav-link" aria-expanded="false">
                                ...
                                <li class="side-nav-item">
                                    ...
                                    <ul class="side-nav-third-level mm-collapse" aria-expanded="false">
                                        ...
                                        <li class="side-nav-item">
                                            ...
                                            <ul class="side-nav-forth-level mm-collapse" aria-expanded="false">
                                                <li>
    ...
    <div class="simplebar-placeholder" style="width: auto; height: 1408px;"></div>
</div>
...
<div class="simplebar-track simplebar-vertical" style="visibility: visible;">
    <div class="simplebar-scrollbar"
    style="height: 188px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
</div>
</div>
<!-- Sidebar -left -->
